    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-900">
            <form className="flex flex-col gap-3 bg-gray-800 p-8 w-[450px] rounded-2xl font-sans" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center border border-gray-700 rounded-xl h-12 pl-2 transition-colors duration-200 bg-gray-700 focus-within:border-blue-600">
                ...
                <p className="text-center text-gray-100 text-sm my-1">
                    ...
                    <span className="text-blue-600 text-sm font-medium cursor-pointer ml-1" onClick={()=>{SetRegister(true)}}>Sign Up</span>
                </p>
